...
_b(doc, 'Network discovery via nmap with agent-driven nuclei and httpx scanning, plus wireless assessment via the Aircrack-ng suite. Structured host table with service fingerprinting and optional network topology diagram. Device classifier identifies 40+ device roles including firewalls, domain controllers, NVRs, IoT, hypervisors, and backup systems.')
...
_t(doc, ['Project','Stars','Role in PortShim'], [
    ...
    ['subfinder','-','Subdomain enumeration (installed; no pipeline wiring yet)'],
